...
#include "../../Core/Inc/dd/ddboot.h"
#include "../../Core/Inc/dd/ddbootpro.h"
#include "../../Core/Inc/dd/ddflashops.h"
#include "main.h"
#include "rtc.h"
...
static void UpdateCRC(uint8_t *data, uint16_t length)
{
    uint16_t crc = currentFile.calculatedCRC;
